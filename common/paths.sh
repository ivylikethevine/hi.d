...
export _HI_TEST_SSH_DISCONNECT="$_HI_ROOT/tests/ssh_disconnect_test.sh"
...
export _HI_TEST_CHECK="$_HI_ROOT/tests/check_test.sh"
export _HI_TEST_HEADER="$_HI_ROOT/tests/header_test.sh"
export _HI_TEST_SHARED="$_HI_ROOT/tests/shared_test.sh"
export _HI_TEST_GIT_PROMPT="$_HI_ROOT/tests/git_prompt_test.sh"
