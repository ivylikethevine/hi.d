...
# requires HI_ROOT and HI_TMPDIR be set correctly
...
export _HI_HOST_COLOR_FILE="$HI_ROOT/common/host_colors"
export _HI_USER_COLOR_FILE="$HI_ROOT/common/user_colors"
...
export _HI_CREATE_COLORS="$HI_ROOT/local/create_host_colors.sh"
export _HI_GROUP_COLORS="$HI_ROOT/local/group_colors"
