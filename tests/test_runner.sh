...
if ! declare -p _HI_TESTS >/dev/null 2>&1; then
  _HI_TESTS=(
    "fast:aliases:compat/alias_test.sh"
    "fast:alias_fallthrough:compat/alias_fallthrough_test.sh"
    "fast:shellcheck:compat/shellcheck_test.sh"
    "fast:install:scripts/install_test.sh"
    "fast:uninstall:scripts/uninstall_test.sh"
    "fast:hi:compat/hi_test.sh"
    "fast:check:compat/check_test.sh"
    "fast:header:compat/header_test.sh"
    "fast:shared:compat/shared_test.sh"
    "fast:git_prompt:compat/git_prompt_test.sh"
    "fast:targets:compat/targets_test.sh"
    "fast:paths:compat/paths_test.sh"
    "fast:color_preview:compat/color_preview_test.sh"
    "fast:load:compat/load_test.sh"
